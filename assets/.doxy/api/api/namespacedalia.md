...
|  constexpr size\_t | [**MAX\_STR\_LEN\_DEVICE**](#variable-max_str_len_device)   = `256`<br> |
...
| Type | Name |
| ---: | :--- |
|  constexpr size\_t | [**MAX\_STR\_LEN\_ASSET\_PATH**](#variable-max_str_len_asset_path)   = `256`<br> |
...
------------------------------
The documentation for this class was generated from the following file `engine/include/dalia/audio/DeviceControl.h`
